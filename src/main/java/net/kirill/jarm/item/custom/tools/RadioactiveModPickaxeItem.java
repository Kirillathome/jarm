...
public class RadioactiveModPickaxeItem extends PickaxeItem {
    public RadioactiveModPickaxeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
