package net.kirill.jarm.item.custom.armor;
...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    LEAD("lead", 18, new int[]{2, 6, 7, 2}, 7, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2.5f, 2.0f, () -> Ingredient.ofItems(ModItems.LEAD_INGOT));
