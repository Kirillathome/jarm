...
public class RadioactiveModHoeItem extends HoeItem {
    public RadioactiveModHoeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
