...
public class UraniumAppleItem extends Item {
    public UraniumAppleItem(Settings settings){
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext){
        ...
        tooltip.add(new TranslatableText("tooltip.jarm.uranium_apple_item").formatted(Formatting.ITALIC).formatted(Formatting.DARK_GRAY));
    }
    @Override
